...
\newcommand{\plannerof}[3]{%
    ...
    \def\schoolinfounit{\RaggedRight%
        ...
        {\color{green!20!black}\large\sffamily Control de Plan de Trabajo}\\
...
\JSONParseArrayMapFunction[%
    code before={},
    code after={}
]{\weekdata}{general.Nombres}{\rotateitem}%
}
...
\newcommand{\fillingradebox}[1][]{\tikz[baseline]{\draw[black!75,thin,rounded corners=1,#1] (0,-0.125) rectangle (0.52, 0.345);}}
\def\listableta{\adjustbox{max width=0.95\linewidth}{\JSONParseArrayValue} & \fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\fillingradebox[dotted]\;\\\hline }

\newcommand{\coolTitle}[1]{% %
\booknode{\color{white}\large\scshape\bfseries\JSONParseValue{\weekdata}{weeks[#1].SemanaEscolar}} \quad \rangofechas{\fechainicio}{\fechacierre}\raisebox{-0.3pt}{\periodoslectivos{#1}} \JSONParseValue{\weekdata}{weeks[#1].Tema} {\small\color{black!30} \hfill \nombres}  \\[-2.8em] 
}

\newcommand{\rotateitem}{%
\fontsize{8}{18}\selectfont\rotatebox{270}{\JSONParseArrayValue} \! \; %
}
