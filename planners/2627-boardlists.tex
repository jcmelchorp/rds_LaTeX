...
%\JSONParseValue[store in=\disciplina]{\weekdata}{general.Asignatura}
...
\def\columnbox{%
\tcbox[enhanced,on line,drop fuzzy shadow=black,size=fbox,colback=violet!10!white]{\fontsize{20}{8}\selectfont\JSONParseArrayValue}\\ %
}
