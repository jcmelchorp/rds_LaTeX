...
%         \put (0.045,-0.44) {\includegraphics[width=1.6cm]{logo45.png}}
%     \end{picture}
% }
...
\newcommand{\fillgradebox}[1][]{\tikz[baseline]{\draw[black!75,thin,rounded corners=1,#1] (0,-0.125) rectangle (0.94, 0.345);}}
\def\listableta{\adjustbox{max width=0.95\linewidth}{\JSONParseArrayValue} & {\fbox{\phantom{oooo}}\;\fillgradebox[dotted]\;\fillgradebox[dotted]\;\fillgradebox[dotted]\;\fillgradebox[dotted]\;\fillgradebox[dotted]\;\fillgradebox[rdsColor]}\\\hline }

\newcommand{\awesomeTitle}[1]{% %
...
\rangoofechas{\fechainicio}{\fechacierre}\raisebox{-0.3pt}{\periodoslectivos{#1}}%  
}
...
\begin{tcolorbox}[unitbox,title=\unitboxtitle,breakable,halign=center]
	...
	\adjustbox{max width=\linewidth}{%
		\begin{tikzpicture}[every calendar/.style={week list},every day/.style={anchor=mid}]
			...
			\matrix[%
				...
				\calperiod{2026-08-31}{2026-09-last} & \calperiod{2026-10-01}{2026-10-last} & \calperiod{2026-11-01}{2026-11-22} \\
	...
	\end{center}
	\JSONParseArrayMapInline{\weekdata}{weeks}{\sem{#1}}
\end{tcolorbox}
\end{document}