...
\begin{questions}    \large
    \question[8] \include*{../unit/question087a}
    \newpage
    \question[8]{Relaciona cada enunciado con el concepto que le corresponda.
    ...
    \question[24]{\include*{../unit/question076a}}
    % \question[4]{\include*{../unit/question076b}}
    \newpage

    \question[22] \include*{../unit/question085d}
    \newpage

    \question[8]{Elige la respuesta correcta:
    ...
    \question[20]{Selecciona la respuesta correcta:
    ...
    % \question[4] \include*{../unit/question077a}


    \newpage
    % \question[10] \include*{../unit/question088b}
    ...
    % \newpage
    % \question[10] \include*{../unit/question090a}
    % \question[10] \include*{../unit/question089b}
    % \newpage
    % \question[10] \include*{../unit/question087c}
    % \question[15] \include*{../unit/question085c}
\end{questions}
\end{document}