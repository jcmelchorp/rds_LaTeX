...
\begin{minipage}{0.67\textwidth}
    \begin{parts}
        \part Grupo formado por la Vía Láctea y unas 30 galaxias más.\dashfill$\large\square$
        \part Son cúmulos de galaxias.\dashfill$\large\square$
        \part Grupo formado por la Vía Láctea y otras 14 galaxias gigantes que integra una estructura en forma de anillo. \dashfill$\large\square$
        \part Grupo de galaxias cuyos tamaños típicos son de 2 a 3 Mpc.\dashfill$\large\square$
    \end{parts}
\end{minipage}%%
