...
\unidad{2}
\title{Repaso para {\color{brown}recuperar} la Unidad}
\aprendizajes{
...
\begin{questions}
     ...
     \questionboxed[8]{Analiza el siguiente problema y selecciona la respuesta correcta para cada una de las preguntas:
          ...
          \begin{parts}
               ...
               \begin{oneparchoices}\footnotesize%
                    \CorrectChoice 204.436 km/h \choice 204.430 km/h \choice 197.63 km/h \choice 202.435 km/h
               \end{oneparchoices}
               ...
               \begin{multicols}{3}
                    ...
                    \begin{solutionbox}{5cm}\scriptsize%
                         ...
                         \begin{align*}
                              ...
                              1,000 \text{ cue.} & = 1 m                                   \\
                              \therefore
                              v_c                   & = 0.322 \cdot (1,000 \text{ cue.})/s \\
                              v_c                   & = 322  \text{ cue.}/s
                         \end{align*}
     ...
     \questionboxed[5]{\include*{../question/old/question033}}
     ...
     \questionboxed[4]{Completa las afirmaciones de acuerdo con la información que presenta la gráfica de la figrua \ref{fig:dist_tiempo_01}.
          ...
          \begin{minipage}[t]{0.65\linewidth}
               \begin{parts}
                    ...
                    \begin{solutionbox}{2.8cm}
                         ...
                         \[ v  =\frac{d}{t}=\frac{5\text{ m}}{1\text{s}} =5 \text{ m/s}\]                             
                    \end{solutionbox}
                    ...
                    \begin{solutionbox}{3.5cm}
                         ...
                         \[ v =\frac{d}{t} =\frac{15\text{ m}}{6\text{s}} =2.5\text{ m/s}\]
                    \end{solutionbox}
               \end{parts}
          \end{minipage}
     }
     ...
     \begin{multicols}{2}
          ...
          \questionboxed[2]{¿Qué fuerza tendrías que aplicar para subir un sillón de 2500 N
               ...
               \begin{solutionbox}{5.5cm}
                    De la ecuación del plano inclinado se tiene:
                    \[F_1 \times d_1= F_2 \times d_2\]
                    donde $F_1=2500$ N, $d_1=8$ m, $d_2=18m$
                    $\Rightarrow$
                    \begin{eqnarray}
                              2500 \times 8            & = &		F_2 \times 18 \nonumber\\
                              \frac{2500 \times 8}{18} & = &  F_2          \nonumber\\
                              \frac{10000}{18}         & = &	    F_2       \nonumber\\
                              1111.11 &=& F_2 \nonumber
                    \end{eqnarray}
               \end{solutionbox}
     ...
     \questionboxed[8]{
          \begin{bA}
               ...
               En la gráfica de la figura \ref{fig:dist_tiempo_02} se representan sus movimientos.
          \end{bA}
     ...
     \begin{multicols}{2}
          \questionboxed[2]{¿Qué fuerza se debe aplicar a una caja de 679 N de peso para subirla a un templete a una altura de 80 cm si se usa una rampa de 560 cm?
               ...
               \begin{solutionbox}{4.5cm}
                    De la ecuación del plano inclinado se tiene:
                    \[F_1 \times d_1= F_2 \times d_2\]
                    donde $F_1=679$ N, $d_1=0.80$ m, $d_2=5.60$ m
                    $\Rightarrow$
                    \begin{eqnarray}
                              679 \times 0.80  & = &      F_2 \times 5.60 \nonumber\\
                              \dfrac{679 \times 0.80}{5.60} & = & F_2  \nonumber\\
                              97 \text{N} &= &F_2 \nonumber
                         \end{eqnarray}
               \end{solutionbox}
          }
          ...
          \questionboxed[2]{¿De qué longitud tendrá que ser el plano inclinado por utilizar si deseas
               subir un peso de 200 N a una altura de 1.2 m, si tu máxima capacidad te permite
               aplicar una fuerza de 50 N?

               \begin{solutionbox}{4.5cm}
                    De la ecuación del plano inclinado se tiene:
                    \[F_1 \times d_1= F_2 \times d_2\]
                    donde $F_1=200$ N, $d_1=2$ m, $F_2=50$ N
                    $\Rightarrow$
                    \begin{eqnarray}
                              200 \times 1.2    & = & 50 \times d_2 \nonumber\\
                              \dfrac{200 \times 1.2}{50} & =  &d_2 \nonumber\\
                              4.8 \text{m} &=& d_2 \nonumber
                    \end{eqnarray}
               \end{solutionbox}
          }
     ...
     \questionboxed[6]{
          ...
          \begin{multicols}{2}
               \begin{figure}[H]
                    \centering
                    \includegraphics[width=0.8\linewidth]{dist_tiempo_04}
               ...
               \begin{parts}
                    ...
                    \begin{minipage}{0.4\linewidth}
                         \begin{solutionbox}{3cm}
                              \includegraphics[width=\linewidth]{dist_tiempo_04j}
                         \end{solutionbox}
                    \end{minipage}
                    ...
                    \begin{minipage}{0.4\linewidth}
                         \begin{solutionbox}{3cm}
                              \includegraphics[width=\linewidth]{dist_tiempo_04h}
                         \end{solutionbox}
                    \end{minipage}
                    ...
                    \begin{minipage}{0.4\linewidth}
                         \begin{solutionbox}{3cm}
                              \includegraphics[width=\linewidth]{dist_tiempo_04e}
                         \end{solutionbox}
                    \end{minipage}
                    ...
                    \begin{minipage}{0.4\linewidth}
                         \begin{solutionbox}{3cm}
                              \includegraphics[width=\linewidth]{dist_tiempo_04c}
                         \end{solutionbox}
                    \end{minipage}
                    ...
                    \begin{minipage}{0.4\linewidth}
                         \begin{solutionbox}{3cm}
                              \includegraphics[width=\linewidth]{dist_tiempo_04b}
                         \end{solutionbox}
                    \end{minipage}
                    ...
                    \begin{minipage}{0.4\linewidth}
                         \begin{solutionbox}{3cm}
                              \includegraphics[width=\linewidth]{dist_tiempo_04a}
                         \end{solutionbox}
                    \end{minipage}
     ...
     \begin{multicols}{2}
               \begin{parts}
                    ...
                    \part La aceleración es el cambio en el valor de la distancia.
          ...
          \begin{multicols}{2}
               ...
               \begin{parts}
                    ...
                    \begin{checkboxes}
                         ...
                         \CorrectChoice El autobús con menos niños.
                    ...
                    \begin{checkboxes}
                         ...
                         \CorrectChoice Es el doble que la del primero.
                    ...
                    \begin{checkboxes}
                         \CorrectChoice Aumenta cuatro veces.
                         \choice Se mantiene igual.
                    ...
                    \begin{checkboxes}
                         ...
                         autobús.
                         \CorrectChoice Los niños sienten que son empujados hacia la izquierda del
                         autobús.
                    \end{checkboxes}
               \end{parts}
          \end{multicols}
     ...
     \questionboxed[10]{Elige la respuesta para cada pregunta, a partir de las imágenes de la figura \ref{fig:camionesdecarga01}.
          ...
          \begin{multicols}{2}
               ...
               \begin{parts}
                    ...
                    ¿a cuál de ellos le resultaría más dificil frenar?
                    ...
                    \part ¿Cuál podría aumentar más rapido su velocidad?
