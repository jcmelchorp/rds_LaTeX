...
\end{multicols}
\begin{questions}
     \questionboxed[8]{\include*{../unit/question087a}}
     \newpage
     ...
     \ejemplosboxed[\include*{../unit/question076aaa}]

     \newpage

     \questionboxed[24]{\include*{../unit/question076a}}

     % \questionboxed[4]{\include*{../unit/question076b}}
     \ejemplosboxed[\include*{../unit/question085c}]

     \newpage

     \questionboxed[22]{\include*{../unit/question085d}}
     \newpage
     ...
     % \questionboxed[4] \include*{../unit/question077a}


     % \newpage
     % \questionboxed[10] \include*{../unit/question088b}


     % \newpage
     % \questionboxed[10] \include*{../unit/question090a}
     % \questionboxed[10] \include*{../unit/question089b}
     % \newpage
     % \questionboxed[10] \include*{../unit/question087c}
     % \questionboxed[15] \include*{../unit/question085c}
\end{questions}
\end{document}
