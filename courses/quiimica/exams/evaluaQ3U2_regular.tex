...
\begin{document}
\begin{questions}
    \question[10]{\include*{../unit/question015}}
    \newpage
    \question[10]{\include*{../unit/question004}}
    \question[5] {\include*{../unit/question008}}
    \newpage
    \question[10]{ \include*{../unit/question025b}}

    % \newpage
    % \begin{multicols}{3}
    \question[10]{ \include*{../unit/question026f}}
    \question[10]{ \include*{../unit/question026q}}
    \question[10]{ \include*{../unit/question026i}}
% \end{multicols}

    \question[10]{ \include*{../unit/question012}}
    \newpage
    \question[5] {\include*{../unit/question016}}

    \setlength{\columnsep}{1cm}
    \begin{multicols}{2}
        \question[5] {\include*{../unit/question013}}

        \columnbreak

        \question[5] {\include*{../unit/question014b}}
    \end{multicols}
