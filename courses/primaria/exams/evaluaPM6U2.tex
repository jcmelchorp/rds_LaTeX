...
\author{Maestra Sandra Gabino Román}
\begin{document}
\vfill
\tableofcontents
\afterpage{\blankpage}
...
% }
	...
	\question[4]{Escribe en el recuadro el número decimal que representa el punto en la recta numérica de cada imagen:
	...
	\question[4]{\textbf{Redondea} los siguientes números decimales como se pide:
   ...
   \end{multicols}
	...
	\question[4]{Convierte las siguientes fracciones a decimal:
	...
	\question[4]{Convierte los siguientes números decimales a una fracción \textbf{simplificada} a su mínima expresión:
	...
	\question[6]{Escribe sobre la línea la clasificación de cada una de las fracciones: (\textit{propias, impropias o mixtas}):
...
\end{parts}
	...
	\question[4]{Escribe la fracción que representa el punto en la recta numérica de cada imagen:
	...
	\question[5]{Escribe sobre la línea el símbolo de mayor que ($>$), menor que ($<$), o igual ($=$) según corresponda.
...
\newpage
	\question[6]{Calcula lo que se te pide en cada inciso:
	...
	\question[5]{Simplifica a su mínima expresión las siguientes fracciones usando el máximo común divisor:
	...
	\question[4]{Indica si las siguientes fracciones son equivalentes o no:
