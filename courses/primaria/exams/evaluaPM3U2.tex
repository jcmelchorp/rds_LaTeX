...
\subsection{Notación desarrollada}
	...
	\question[5]{Escribe la notación desarrollada de cada uno de los siguientes números:
...
\section{Unidad 2}
	...
	\question[15]{Reponde las siguientes tablas de multiplicar:
	...
	\question[15]{Completa las siguientes tablas de multiplicar:
...
\question[12]{Realiza las siguientes multiplicaciones:
...
\question[16]{Realiza las siguientes divisiones:
...
% 	\subsection*{Tablas de multiplicar}
% \question[8]{Reponde las siguientes tablas de multiplicar:
...
% 	\question[8]{Completa las siguientes tablas de multiplicar:
