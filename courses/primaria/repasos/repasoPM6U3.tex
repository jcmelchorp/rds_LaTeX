...
\begin{questions}\large
	...
	\questionboxed[8]{Determina la mediana, la moda y el promedio en los siguientes conjuntos de datos:
	...
	\questionboxed[6]{Los resultados de una encuesta se muestran en la siguiente gráfica de barras:
	...
	\questionboxed[4]{Calcula el valor de $x$ en las siguientes proporciones:
	...
	\questionboxed[6]{Calcula el perímetro y área de los siguientes círculos:
	...
	\questionboxed[14]{Realiza las siguientes operaciones:
	...
	\questionboxed[14]{Realiza las siguientes conversiones de unidades de longitud y masa:
