    ...
    \subsubsection{Media, Mediana, Moda y Desviación media}
...
Se sabe que el perímetro de un pentágono es: $P=5l$, entonces el perímetro del terreno es: \[P=5(15)=75\text{m}\]
    ...
    \subsection{Plano cartesiano y recta}
    ...
    \subsubsection{Pendiente dados dos puntos}
...
\end{multicols}
    ...
    \subsubsection{Ecuaciones lineales con fracciones}
    ...
    \subsection{Sistemas de ecuaciones}
        % \subsubsection{{Método de sustitución e igualación}
    ...
    % 
    \subsubsection{Sistema de ecuaciones 3x3}
    ...
    \subsubsection{Sistema de ecuaciones con fracciones}
