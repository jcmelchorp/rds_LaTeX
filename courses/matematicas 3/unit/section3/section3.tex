\section{Unidad 3}
\subsection{Sucesiones cuadráticas y geométricas}
\subsubsection{Sucesión cuadrática}
...
\ejemplosboxed[]{Escribe los primeros 4 términos de las siguientes sucesiones cuadráticas:
    ...
    \subsubsection{Completando la sucesión cuadrática}
    ...
    \subsubsection{Razón de una sucesión geométrica}
    ...
    \subsubsection{Binomios conjugados}
    ...
    \subsubsection{Binomios con término común}
    ...
    \subsubsection{Binomio al cuadrado}
    ...
    \subsubsection{Binomios de la forma (mx+a)(nx+b)}
    ...
    % \subsubsection{Clasificación de ecuaciones cuadráticas}
    % \ejemplosboxed[]{
    %             \begin{multicols}{2}
    %                 \begin{parts}
    %                     \part  \fillin[][0.5cm]
    ...
    \subsubsection{Ecuaciones cuadráticas incompletas}
    ...
    \subsubsection{Ecuaciones cuadráticas completas}
    ...
    % \subsubsection{Identificación de lados}
    ...
    \subsubsection{Hallando la hipotenusa y catetos}
    ...
    % \subsubsection{Hallando el cateto}
    ...
    \subsubsection{Áreas y perímetros}
    ...
    \subsubsection{Identificando lados}
    ...
    \subsubsection{Identificando funciones}
    ...
    \subsubsection{Encontrando lados}
    ...
    \subsubsection{Encontrando ángulos}
