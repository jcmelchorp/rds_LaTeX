...
\begin{questions}
    ...
    \questionboxed[5]{Escribe el número que completa correctamente las sumas y restas para cada inciso:
    ...
    \questionboxed[5]{Realiza las siguientes multiplicaciones:
        ...
        \begin{multicols}{5}
            \begin{parts}
                ...
                \fi
                \part \ifprintanswers{\large \quad \opmul[hfactor=decimal,resultstyle=\color{red},displayintermediary=all]{19}{19} \\[4em]}
                \else{          \large \quad \opmul[hfactor=decimal,resultstyle=\color{white},displayintermediary=None]{19}{19} \\[4em]}
                \fi

                \part \ifprintanswers{\large \quad \opmul[hfactor=decimal,resultstyle=\color{red},displayintermediary=all]{25}{25} \\[4em]}
                \else{          \large \quad \opmul[hfactor=decimal,resultstyle=\color{white},displayintermediary=None]{25}{125} \\[4em]}
                \fi

                \part \ifprintanswers{\large \quad \opmul[hfactor=decimal,resultstyle=\color{red},displayintermediary=all]{18}{18} \\[4em]}
                \else{          \large \quad \opmul[hfactor=decimal,resultstyle=\color{white},displayintermediary=None]{18}{18} \\[4em]}
                \fi


                \part \ifprintanswers{\large \quad \opmul[hfactor=decimal,resultstyle=\color{red},displayintermediary=all]{17}{17} \\[4em]}
    ...
    \questionboxed[5]{Escribe el número que completa correctamente las multiplicaciones para cada inciso:
    ...
    \questionboxed[5]{Realiza las siguientes divisiones:
    ...
    \questionboxed[10]{Escribe numéricamente la fracción que representa cada una de las imágenes en cada inciso:

        \begin{multicols}{2}
            \begin{parts}
                \part \fracquestion{$\dfrac{8}{5}$}{\circlefraction{8}{5}}
                \part \fracquestion{$\dfrac{6}{4}$}{\circlefraction{6}{4}}
                \part \fracquestion{$\dfrac{5}{3}$}{\circlefraction{5}{3}}
                \part \fracquestion{$\dfrac{9}{8}$}{\circlefraction{9}{8}}
            \end{parts}
        \end{multicols}
    }
