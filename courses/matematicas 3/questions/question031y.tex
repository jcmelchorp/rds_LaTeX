Encuentra el valor de la incógnita en el triángulo de la figura \ref{fig:angle_triangle_33}.

\begin{minipage}[t][5cm][b]{0.3\textwidth}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.99\linewidth]{../images/angle_triangle_33.png}
        \caption{}
        \label{fig:angle_triangle_33}
    \end{figure}
\end{minipage}\hfill
\begin{minipage}[t]{0.65\textwidth}
    \begin{solutionbox}{5cm}
        ...
        \[x=180^\circ-115^\circ-32^\circ=33^\circ\]
    \end{solutionbox}
\end{minipage}
