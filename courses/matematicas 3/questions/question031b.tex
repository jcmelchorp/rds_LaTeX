Encuentra el valor de la incógnita en el triángulo de la figura \ref{fig:angle_triangle_02}.

\begin{minipage}[t][5cm][b]{0.3\textwidth}
    \begin{figure}[H]
        \centering
        \includegraphics[width=0.99\linewidth]{../images/angle_triangle_02.png}
        \caption{}
