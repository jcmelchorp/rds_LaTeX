...
\section{Unidad 1}
	...
	\question[1]{Realiza las siguientes \emph{sumas}:
	...
	\question[1]{Realiza las siguientes \emph{restas}:
	...
	\question[1]{Realiza las siguientes \emph{multiplicaciones}:
	...
	\question[1]{Calcula el \textbf{cociente} y el \textbf{residuo} de las siguientes \emph{divisiones}:
	...
	\question[1]{Resuelve los siguientes problemas:
	...
	\question[1]{Escribe el \textbf{número} que representa el punto indicado en la recta numérica de cada uno de los siguientes incisos.
	...
	% \addcontentsline{toc}{subsubsection}{Comparación de negativos}
	\subsubsection{Comparación de negativos}

	\question[1]{Escribe sobre la línea el símbolo de mayor que ($>$), menor que ($<$), o igual ($=$) según corresponda.
	...
	% \addcontentsline{toc}{subsubsection}{Suma y resta con negativos}
	\subsubsection{Suma y resta con negativos}

	\question[1]{Realiza las siguientes sumas y restas con números negativos:
	...
	\question[1]{Realiza las siguientes multiplicaciones y divisiones con números negativos:
	...
	\question[2]{Realiza las siguientes potencias de números negativos:
	...
	\question[2]{Realiza las siguientes operaciones con exponentes:
	...
	\question[1]{Escribe en notación científica los siguientes números:
	...
	\question[1]{Escribe en notación decimal los siguientes números:
	...
	\question[1]{Escribe las coordenadas de los puntos indicados en el plano cartesiano de cada uno de los siguientes incisos.
	...
	\question[1]{Selecciona la opcion que corresponde a la pendiente de la recta en cada uno de los siguientes incisos:
	...
	\question[1]{Identifica la pendiente y ordenada de las siguientes rectas:
	...
	\question[2]{Escribe la ecuación de cada una de las rectas en los siguientes planos cartesianos:
	...
	\question[1]{Escribe el número decimal que representa cada porcentaje:
	...
	\question[1]{Escribe el porcentaje que representa cada número decimal:
	...
	\question[1]{Calcula los porcentajes de cada una de las siguientes cantidades:
...
\subsection{Círculo}
	...
	\question[2]{Encuentra el \textbf{perímetro} y el \textbf{área} de los siguientes círculos:

		\begin{multicols}{3}
			\begin{parts}
				% \part \includegraphics[width=0.85\linewidth]{../images/mex_0001.png}\\
				% Perímetro: \fillin[][0.3in] \quad Área: \fillin[][0.3in]
				\part \includegraphics[width=0.85\linewidth]{../images/mex_0002.png}\\
				...
				% \part \includegraphics[width=0.85\linewidth]{../images/mex_0003.png}\\
				% Perímetro: \fillin[][0.3in] \quad Área: \fillin[][0.3in]
				% \part \includegraphics[width=0.85\linewidth]{../images/mex_0004.png}\\
				% Perímetro: \fillin[][0.3in] \quad Área: \fillin[][0.3in]
				\part \includegraphics[width=0.85\linewidth]{../images/mex_0005.png}\\
				...
				\part \includegraphics[width=0.85\linewidth]{../images/mex_0009.png}\\
	...
	\question[1]{Encuentra el \textbf{perímetro} y el \textbf{área} de los siguientes círculos:

		\begin{multicols}{3}
			\begin{parts}
				\part \includegraphics[width=0.85\linewidth]{../images/mex_0006.png}\\
				...
				% \part \includegraphics[width=0.85\linewidth]{../images/mex_0007.png}\\
				% Perímetro: \fillin[][0.3in] \quad Área: \fillin[][0.3in]
				\part \includegraphics[width=0.85\linewidth]{../images/mex_0008.png}\\
				...
				% \part \includegraphics[width=0.85\linewidth]{../images/mex_0010.png}\\
				% Perímetro: \fillin[][0.3in] \quad Área: \fillin[][0.3in]
				\part \includegraphics[width=0.85\linewidth]{../images/mex_0011.png}\\
				...
				% \part \includegraphics[width=0.85\linewidth]{../images/mex_0012.png}\\
				% Perímetro: \fillin[][0.3in] \quad Área: \fillin[][0.3in]
			\end{parts}
		\end{multicols}
	}
	...
	\question[1]{Responde a las siguientes preguntas:
	...
	\question[1]{Calcula el valor del \textbf{ángulo} $x$:

		\begin{multicols}{3}
			\begin{parts}
				\part \includegraphics[width=.7\linewidth]{../images/mex_0043.png}
				$x=$\fillin[$136^{\circ}$][0in]

				\part \includegraphics[width=.7\linewidth]{../images/mex_0044.png}
				$x=$\fillin[$80^{\circ}$][0in]

				\part \includegraphics[width=.7\linewidth]{../images/mex_0046.png}
				$x=$\fillin[$156^{\circ}$][0in]

				\part \includegraphics[width=.7\linewidth]{../images/mex_0047.png}
				$x=$\fillin[$56^{\circ}$][0in]

				\part \includegraphics[width=.7\linewidth]{../images/mex_0049.png}
				$x=$\fillin[$55^{\circ}$][0in]

				\part \includegraphics[width=.7\linewidth]{../images/mex_0050.png}
	...
	\question[1]{Calcula el valor del \textbf{arco} $x$:

		\begin{multicols}{3}
			\begin{parts}
				\part \includegraphics[width=.7\linewidth]{../images/mex_0052.png}
				$x=$\fillin[$42$][0in]

				\part \includegraphics[width=.7\linewidth]{../images/mex_0053.png}
				$x=$\fillin[$76$][0in]

				\part \includegraphics[width=.7\linewidth]{../images/mex_0054.png}
				$x=$\fillin[$76$][0in]

				\part \includegraphics[width=.7\linewidth]{../images/mex_0055.png}
				$x=$\fillin[$113$][0in]

				\part \includegraphics[width=.7\linewidth]{../images/mex_0056.png}
				$x=$\fillin[$82$][0in]

				\part \includegraphics[width=.7\linewidth]{../images/mex_0057.png}
				$x=$\fillin[$83$][0in]
			\end{parts}
		\end{multicols}
	}
	...
	\question[2]{Calcula el \textbf{área} de cada uno de los siguientes sectores circulares:

		\begin{multicols}{3}
			\begin{parts}
				\part \includegraphics[width=.7\linewidth]{../images/mex_0058.png}
				...
				\part \includegraphics[width=.7\linewidth]{../images/mex_0059.png}
				...
				\part \includegraphics[width=.7\linewidth]{../images/mex_0060.png}
				...
				\part \includegraphics[width=.7\linewidth]{../images/mex_0061.png}
				...
				\part \includegraphics[width=.7\linewidth]{../images/mex_0062.png}
				...
				\part \includegraphics[width=.7\linewidth]{../images/mex_0063.png}
	...
	\question[2]{Encuentra el \textbf{perímetro} y el \textbf{área} de las siguientes figuras:

		\begin{multicols}{3}
			\begin{parts}\footnotesize%
				% \part \includegraphics[width=\linewidth]{../images/mex_0013.png}
				% Perímetro: \\
				% \fillin[$P=(12\times 3) + (8\times 2)=36+16=52$][0in] \\
				% Área: \\
				% \fillin[$A=12^2+\dfrac{8^2}{2}=144+32=177$][0in]

				\part \includegraphics[width=.7\linewidth]{../images/mex_0014.png} 
				...
				% \part \includegraphics[width=.5\linewidth]{../images/mex_0015.png}
				% Perímetro: \\
				% \fillin[$P=(18\times 3) + (11\times 2)=36+16=52$][0in] \\
				% Área: \\
				% \fillin[$A=18^2+\dfrac{11^2}{2}=324+60.5=384.5$][0in]

				% \part \includegraphics[width=\linewidth]{../images/mex_0019.png}
				% Perímetro: \\
				% \fillin[$P=(60\times 2) + (22\times 2)=120+44=164$][0in] \\
				% Área: \\
				% \fillin[$A=60\times 22=1320$][0in]

				\part \includegraphics[width=.5\linewidth]{../images/mex_0016.png} 
				...
				\part \includegraphics[width=.8\linewidth]{../images/mex_0020.png} 
				...
				%  \part \includegraphics[width=.5\linewidth]{../images/mex_0017.png}
				%  Perímetro: \\
				%  \fillin[$P=(31\times 3) =93$][0in] \\
				%  Área: \\
				%  \fillin[$A=\frac{31\times 24}{2}=372$][0in]

				%  \part \includegraphics[width=.5\linewidth]{../images/mex_0018.png}
				%  Perímetro: \\
	...
	\question[3]{Calcula el \textbf{volumen}, el \textbf{área lateral} y el \textbf{área total} de las siguientes figuras:

			\begin{parts}
				\part Cilindro con altura $h=17$ cm y un radio $r=4$ cm.

				\begin{minipage}{.25\linewidth}
					\includegraphics[width=0.8\linewidth]{../images/mex_0024.png}
				\end{minipage}\hfill
				...
				\begin{minipage}{.25\linewidth}
					\includegraphics[width=0.8\linewidth]{../images/mex_0025.png}
				\end{minipage}\hfill
				\begin{minipage}{.75\linewidth}
					Volumen:\\[-2em]
					\begin{solutionbox}{1cm}
	...
	\question[3]{Calcula el \textbf{volumen}, el \textbf{área lateral} y el \textbf{área total} de las siguientes figuras:
		...
		\begin{parts}
			...
			\begin{minipage}{.25\linewidth}
				\includegraphics[width=0.6\linewidth]{../images/mex_0029.png}
			\end{minipage}\hfill
			\begin{minipage}{.75\linewidth}
				Volumen:\\[-2em]
				\begin{solutionbox}{1cm}
			...
			\begin{minipage}{.25\linewidth}
				\includegraphics[width=0.8\linewidth]{../images/mex_0027.png}
			\end{minipage}\hfill
			\begin{minipage}{.75\linewidth}
				Volumen:\\[-2em]
				\begin{solutionbox}{1cm}
	...
	\question[1]{Elige la \textbf{expresión algebraica} correcta para cada uno de los siguientes enunciados:
	...
	\question[2]{Resuelve las siguientes \textbf{sumas} de monomios y polinomios:
	...
	\question[3]{Resuelve las siguientes \textbf{restas} de monomios y polinomios:
	...
	\question[3]{Resuelve las siguientes operaciones convinadas:
	...
	\question[2]{Encuentra el \textbf{perímetro} de las siguientes figuras:

		\begin{multicols}{3}
			\begin{parts}
				% \part \includegraphics[width=\linewidth]{../images/mex_0030.png}\\
				% Perímetro: \fillin[$40x-24y$][1in]
				% \part \includegraphics[width=1.2\linewidth]{../images/mex_0031.png}\\
				% Perímetro: \fillin[$12x+2y+10$][1in]
				\part \includegraphics[width=.9\linewidth]{../images/mex_0032.png}

				Perímetro: \fillin[$12a-18b-30$][0in]
				
				\part \includegraphics[width=.8\linewidth]{../images/mex_0033.png}

				Perímetro: \fillin[$24x+48y-8$][0in]
				% \part \includegraphics[width=\linewidth]{../images/mex_0034.png}\\
				% Perímetro: \fillin[$6x+8y-12$][1in]
				\part \includegraphics[width=.8\linewidth]{../images/mex_0035.png}
	...
	\question[2]{Realiza la siguientes \textbf{multiplicaciones} de polinomios:
	...
	\question[2]{Encuentra el \textbf{área} de las siguientes figuras:

		\begin{multicols}{4}
			\begin{parts}
				\part \includegraphics[width=.85\linewidth]{../images/mex_0036.png}\\[0.5em]
				Área: \fillin[$x^2-6x+9$][0in]

				\part \includegraphics[width=1.2\linewidth]{../images/mex_0037.png}\\[0.5em]
				Área: \fillin[$10x^2-50x$][0in]

				\part \includegraphics[width=1.2\linewidth]{../images/mex_0038.png}\\[0.5em]
				Área: \fillin[$x^2+7x-30$][0in]

				% \part \includegraphics[width=\linewidth]{../images/mex_0039.png}\\
				% Área: \fillin[$2x^2+4x$][1in]

				% \part \includegraphics[width=\linewidth]{../images/mex_0040.png}\\
				% Área: \fillin[$2x^2+11x+14$][1in]

				\part \includegraphics[width=.85\linewidth]{../images/mex_0041.png}\\[0.5em]
	...
	\question[2]{Convierte las siguientes \textbf{unidades de longitud} y de \textbf{masa} como se te pide:
	...
	\question[2]{Convierte las siguientes \textbf{unidades de capacidad} como se te pide:
	...
	\question[1]{Convierte las siguientes \textbf{unidades de área} y \textbf{volumen} como se te pide:
...
%         }]
		...
		\question[1]{Contesta las siguientes preguntas:
    ...
    %                     \includegraphics[width=.85\linewidth]{../images/mexmat00001.png}
    %                 \end{parts}
    %             \end{multicols}
    %         }]

    \question[1]{Los resultados de una encuesta se muestran en la siguiente gráfica de barras:
        ...
        \begin{multicols}{2}
            \begin{parts}
                ...
                \includegraphics[width=.85\linewidth]{../images/mexmat00001a.png}
            \end{parts}
        \end{multicols}
    }
    ...
    %                         \includegraphics[width=\textwidth]{../images/mex_0071.png}
    %                     \end{minipage}\hfill%
    ...
    %                     % \part \includegraphics[width=.7\linewidth]{../images/mex_0071.png}
    ...
    %                     \part
    %                     \begin{minipage}[t]{0.35\linewidth}
    %                         \includegraphics[width=\textwidth]{../images/mex_0072.png}
    %                     \end{minipage}\hfill%
    %                     \begin{minipage}[b]{0.6\linewidth}
    %                         \begin{choices}
    ...
    \question[1]{Determina si las siguientes tablas de datos son o no una relación proporcional:

        \begin{multicols}{2}
            \begin{parts}
                \part
                \begin{minipage}[t]{0.35\linewidth}
                    \includegraphics[width=\textwidth]{../images/mex_0064.png}
                \end{minipage}%
                \begin{minipage}[b]{0.6\linewidth}
                    \begin{choices}
                        \choice Propocional
                ...
                \part
                \begin{minipage}[t]{0.35\linewidth}
                    \includegraphics[width=\textwidth]{../images/mex_0065.png}
                \end{minipage}%
                \begin{minipage}[b]{0.6\linewidth}
                    \begin{choices}
                        \CorrectChoice Propocional
    ...
    %                     \part
    %                     \begin{minipage}[t]{0.35\linewidth}
    %                         \includegraphics[width=\textwidth]{../images/mex_0078.png}
    %                     \end{minipage}\hfill%
    %                     \begin{minipage}[b]{0.6\linewidth}
    ...
    %                     \part
    %                     \begin{minipage}[t]{0.35\linewidth}
    %                         \includegraphics[width=\textwidth]{../images/mex_0073.png}
    %                     \end{minipage}\hfill%
    %                     \begin{minipage}[b]{0.6\linewidth}
    ...
    \question[1]{Determina si las siguientes tablas de datos son o no una relación proporcional:
        ...
        \begin{multicols}{2}
            \begin{parts}
                \part
                \begin{minipage}[t]{0.35\linewidth}
                    \includegraphics[width=\textwidth]{../images/mex_0074.png}
                \end{minipage}%
                \begin{minipage}[b]{0.6\linewidth}
                    \begin{solutionbox}{3.5cm}\small%
                ...
                \part
                \begin{minipage}[t]{0.35\linewidth}
                    \includegraphics[width=\textwidth]{../images/mex_0075.png}
                \end{minipage}%
                \begin{minipage}[b]{0.6\linewidth}
                    \begin{solutionbox}{3.5cm}\small%
                ...
                \part
                \begin{minipage}[t]{0.35\linewidth}
                    \includegraphics[width=\textwidth]{../images/mex_0076.png}
                \end{minipage}%
                \begin{minipage}[b]{0.6\linewidth}
                    \begin{solutionbox}{3.5cm}\small%
                ...
                \part
                \begin{minipage}[t]{0.35\linewidth}
                    \includegraphics[width=\textwidth]{../images/mex_0077.png}
                \end{minipage}%
                \begin{minipage}[b]{0.6\linewidth}
                    \begin{solutionbox}{2.8cm}\small%
    ...
    %                         \includegraphics[width=2\linewidth]{../images/mex_0082.png}
    %                     \end{minipage}\hfill%
    %                     \begin{minipage}[b]{0.6\linewidth}
    %                         \begin{solutionbox}{2cm}
    ...
    %                     \part%
    %                     \begin{minipage}[t]{0.25\linewidth}
    %                         \includegraphics[width=2\linewidth]{../images/mex_0083.png}
    %                     \end{minipage}\hfill%
    %                     \begin{minipage}[b]{0.6\linewidth}
    %                         \begin{solutionbox}{2cm}
    ...
    \question[1]{Escribe la regla de correspondencia (ecuación) de las siguientes tablas:

        \begin{multicols}{2}
            \begin{parts}
                % \part%
                % \begin{minipage}[t]{0.25\linewidth}
                %     \includegraphics[width=2\linewidth]{../images/mex_0084.png}
                % \end{minipage}\hfill%
                % \begin{minipage}[b]{0.6\linewidth}
                %     \begin{solutionbox}{2cm}
                ...
                % \part%
                % \begin{minipage}[t]{0.25\linewidth}
                %     \includegraphics[width=2\linewidth]{../images/mex_0085.png}
                % \end{minipage}\hfill%
                % \begin{minipage}[b]{0.6\linewidth}
                %     \begin{solutionbox}{2cm}
                ...
                \part%
                \begin{minipage}[t]{0.25\linewidth}
                    \includegraphics[width=2\linewidth]{../images/mex_0086.png}
                \end{minipage}\hfill%
                \begin{minipage}[b]{0.6\linewidth}
                ...
                \part%
                \begin{minipage}[t]{0.25\linewidth}
                    \includegraphics[width=2\linewidth]{../images/mex_0087.png}
                \end{minipage}\hfill%
                \begin{minipage}[b]{0.6\linewidth}
    ...
    \question[1]{Escribe los términos faltantes de las siguientes sucesiones aritméticas:
    ...
    \question[1]{Determina la diferencia de las siguientes sucesiones aritméticas:
    ...
    \question[1]{Encuentra el \textit{n-ésimo} término de la siguientes sucesiones aritméticas:
        \begin{multicols}{2}
            \begin{parts}
    ...
    \question[1]{Determina el término general de las siguientes sucesiones aritméticas:
        \begin{multicols}{2}
            \begin{parts}
    ...
    \question[2]{Encuentra el \textit{n-ésimo} término de la siguientes sucesiones aritméticas:
        \begin{multicols}{2}
            \begin{parts}
    ...
    \question[1]{Escribe la expresión algebraica correcta para los siguientes enunciados:
        \begin{multicols}{2}
            \begin{parts}
    ...
    \question[2]{Encuentra el valor numérico de Las siguientes expresiones:
 ...
 \subsubsection{Ecuaciones de primer grado 1}
    ...
    \question[2]{Resuelve las siguientes ecuaciones:
     ...
     \subsubsection{Resolución de problemas}
    \question[2]{Resuelve los siguientes problemas de ecuaciones lineales
        \begin{parts}
    ...
    \question[2]{Utilizando el m\'etodo de tu preferencia, encuentra el valor de $x$ y $y$ para
    ...
    \question[2]{Resuelve el siguiente sistema de ecuaciones lineales con decimales:
        \begin{align*}
            -0.2x+0.4y= & 0.6 \\
            x+2y=       & -3
        \end{align*}
