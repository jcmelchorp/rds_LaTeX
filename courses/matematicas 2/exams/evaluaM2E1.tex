...
\section{Unidad 1}
	...
	\question[1]{Realiza las siguientes operaciones de \textit{cálculo numérico}:
						\begin{multicols}{2}
\begin{parts}
...
\newpage
	...
	\question[1]{Realiza las siguientes multiplicaciones y divisiones con números negativos:
		...
		\begin{multicols}{3}
			\begin{parts}
				\part $(-8)\divisionsymbol (16)=$ \fillin[$\dfrac{1}{2}$][0in]
	...
	\question[2]{Escribe la ecuación de cada una de las rectas en los siguientes planos cartesianos:
		...
		\begin{multicols}{2}
			\begin{parts}
				\part
				\includegraphics[width=.85\linewidth]{../images/plano_cart_rect_-2x.png}\\
				\fillin[$y=-2x$][2in]

				\part
				\includegraphics[width=.85\linewidth]{../images/plano_cart_rect_x-6.png}\\
				\fillin[$y=x-6$][2in]
			\end{parts}
		\end{multicols}
	}
...
\subsection{Círculo}
	...
	\question[3]{Encuentra el \textbf{perímetro} y el \textbf{área} de los siguientes círculos:

		\begin{multicols}{3}
			\begin{parts}
				\part \includegraphics[width=0.9\linewidth]{../images/mex_0006.png}\\
				...
				\part \includegraphics[width=0.9\linewidth]{../images/mex_0009.png}\\
				...
				\part \includegraphics[width=0.9\linewidth]{../images/mex_0011.png}\\
	...
	\question[1]{Calcula el valor del \textbf{arco} $x$:
		...
		\begin{multicols}{3}
			\begin{parts}
				...
				\part \includegraphics[width=.75\linewidth]{../images/mex_0053.png}
				$x=$\fillin[$76$][0in]

				% \part \includegraphics[width=.7\linewidth]{../images/mex_0054.png}
				% $x=$\fillin[$76$][0in]

				\part \includegraphics[width=.75\linewidth]{../images/mex_0055.png}
				$x=$\fillin[$113$][0in]

				% \part \includegraphics[width=.7\linewidth]{../images/mex_0056.png}
				% $x=$\fillin[$82$][0in]

				\part \includegraphics[width=.75\linewidth]{../images/mex_0057.png}
				$x=$\fillin[$83$][0in]
			\end{parts}
		\end{multicols}
	}
