...
\section{Unidad 1}
	...
	\question[1]{Realiza las siguientes potencias de números negativos:
	...
	\question[1]{Realiza las siguientes operaciones con exponentes:
	...
	\question[1]{Escribe la ecuación de cada una de las rectas en los siguientes planos cartesianos:
...
\subsection{Círculo}
	...
	\question[1]{Calcula el \textbf{área} de cada uno de los siguientes sectores circulares:
	...
	\question[1]{Encuentra el \textbf{perímetro} y el \textbf{área} de las siguientes figuras:
	...
	\question[1]{Calcula el \textbf{volumen}, el \textbf{área lateral} y el \textbf{área total} de las siguientes figuras:
	...
	\question[1]{Resuelve las siguientes \textbf{sumas} de monomios y polinomios:
	...
	\question[1]{Resuelve las siguientes \textbf{restas} de monomios y polinomios:
	...
	\question[1]{Resuelve las siguientes operaciones convinadas:
	...
	\question[1]{Encuentra el \textbf{perímetro} de las siguientes figuras:
	...
	\question[1]{Realiza la siguientes \textbf{multiplicaciones} de polinomios:
	...
	\question[1]{Encuentra el \textbf{área} de las siguientes figuras:
	...
	\question[1]{Convierte las siguientes \textbf{unidades de longitud} y de \textbf{masa} como se te pide:
	...
	\question[1]{Convierte las siguientes \textbf{unidades de capacidad} como se te pide:
...
%         }]
    ...
    \question[1]{Encuentra el valor numérico de Las siguientes expresiones:
 ...
 \subsubsection{Ecuaciones de primer grado 1}
    ...
    \question[1]{Resuelve las siguientes ecuaciones:
     ...
     \subsubsection{Resolución de problemas}
    \question[1]{Resuelve los siguientes problemas de ecuaciones lineales
        \begin{parts}
    ...
    \question[1]{Utilizando el m\'etodo de tu preferencia, encuentra el valor de $x$ y $y$ para
    ...
    \question[1]{Resuelve el siguiente sistema de ecuaciones lineales con decimales:
        \begin{align*}
            -0.2x+0.4y= & 0.6 \\
            x+2y=       & -3
        \end{align*}
