...
\begin{questions}
	...
	\questionboxed[10]{Escribe el número que representa el punto indicado en la recta numérica de cada uno de los siguientes incisos.
		...
		\begin{multicols}{2}
			\begin{parts}
				...
				\part \includegraphics[width=0.7\linewidth]{../images/recta_num_-171.png} \\   \fillin[$-171$][1.5in]
				
				\part \includegraphics[width=0.7\linewidth]{../images/recta_num_-3.1.png} \\   \fillin[$-3.1$][1.5in]
				
				\part \includegraphics[width=0.7\linewidth]{../images/recta_num_-2.png}   \\ \fillin[$-2$][1.5in]
				
				\part \includegraphics[width=0.7\linewidth]{../images/recta_num_-3.9.png} \\   \fillin[$-3.9$][1.5in]
				
				% \part \includegraphics[width=0.7\linewidth]{../images/recta_num_-6.png}   \\ \fillin[$-6$][1.5in]
				
				% \columnbreak%
				
				
				% \part \includegraphics[width=0.7\linewidth]{../images/recta_num_1.723.png}\\  \fillin[$1.723$][1.5in]
				
				% \part \includegraphics[width=0.7\linewidth]{../images/recta_num_0.4.png}  \\  \fillin[$0.4.$][1.5in]
				
				% \part \includegraphics[width=0.7\linewidth]{../images/recta_num_5.3.png}  \\  \fillin[$5.3.$][1.5in]
				
				% \part \includegraphics[width=0.7\linewidth]{../images/recta_num_4.112.png}\\  \fillin[$4.11$][1.5in]
				
				% \part \includegraphics[width=0.7\linewidth]{../images/recta_num_3.9.png}  \\  \fillin[$3.9.$][1.5in]
			\end{parts}
		\end{multicols}
	}
	...
	\questionboxed[3]{Escribe sobre la línea el símbolo de mayor que ($>$), menor que ($<$), o igual ($=$) según corresponda.
