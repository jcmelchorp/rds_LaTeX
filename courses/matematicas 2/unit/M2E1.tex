...
\questionboxed[2]{Resuelve los siguientes problemas:
	...
	\ejemplosboxed[4]{Resuelve las siguientes restas de monomios y polinomios:
    ...
    \subsubsection{Perímetro de figuras geométricas}
	 ...
	 \ejemplosboxed[3]{Encuentra el perímetro de las siguientes figuras:
        \begin{multicols}{3}
            \begin{parts}
    ...
    \questionboxed[4]{Convierte las siguientes unidades de masa como se te pide:
        \begin{multicols}{2}
            \begin{parts}
                ...
                \part Convierte 6.5 gramos ($g$) a hectogramos ($Hg$).	   \\ \fillin[$6.5\divisionsymbol 10 \divisionsymbol 10=0.065$][0in]
				\part Convierte 867.4 centigramos ($cg$) a gramos ($g$).     \\ \fillin[$8674\divisionsymbol 10 \divisionsymbol 10=8.6.74$][0in]
				\part Convierte 90.4 miligramos ($mg$) a centigramos ($cg$). \\ \fillin[$90.4\divisionsymbol 10 =9.04$][0in]
				\part Convierte 2.9 decagramos ($Dg$) a miligramos ($mg$).  \\ \fillin[$2.9\times 10 \times 10 \times 10\times 10=29000$][0in]
				\part Convierte 9.01 gramos ($g$) a miligramos ($mg$).      \\ \fillin[$9.01\times 10 \times 10 \times 10=9010$][0in]
            \end{parts}
        \end{multicols}
    }
...
\ejemplosboxed[4]{Convierte las siguientes unidades de capacidad como se te pide:
    ...
    \questionboxed[4]{Convierte las siguientes unidades de capacidad como se te pide:
        \begin{multicols}{2}
            \begin{parts}
...
\ejemplosboxed[4]{Contesta las siguientes preguntas:
    ...
    \ejemplosboxed[6]{Determina si las siguientes tablas de datos son o no una relación proporcional:
    ...
    \subsubsection{Resolución de problemas}
     ...
     \ejemplosboxed[5]{Resuelve los siguientes problemas de ecuaciones lineales
        \begin{parts}
