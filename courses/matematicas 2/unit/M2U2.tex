...
\questionboxed[2]{Resuelve los siguientes problemas:
	...
	\ejemplosboxed[6]{Calcula el \textbf{volumen}, el \textbf{área lateral} y el \textbf{área total} de las siguientes figuras:
		...
		\begin{parts}
			...
			\begin{minipage}{.25\linewidth}
				\includegraphics[width=.9\linewidth]{mex_0025.png}
			\end{minipage}\hfill
			\begin{minipage}{.75\linewidth}
				Volumen:\\[-2em]
				\begin{solutionbox}{1.8cm}
    ...
    \subsubsection{Perímetro de figuras geométricas}
	 ...
	 \ejemplosboxed[3]{Encuentra el perímetro de las siguientes figuras:
        \begin{multicols}{3}
            \begin{parts}
                \part \includegraphics[width=.8\linewidth]{mex_0030.png}
               
				Perímetro: \fillin[$40x-24y$][1in]\\
                
				\part \includegraphics[width=.8\linewidth]{mex_0032.png}

                Perímetro: \fillin[$12a-18b-30$][1in]\\

				\part \includegraphics[width=.9\linewidth]{mex_0031.png}\\
    ...
    \subsubsection{Áreas de figuras geométricas}
	 ...
	 \ejemplosboxed[4]{Encuentra el área de las siguientes figuras:
	...
	\ejemplosboxed[4]{Convierte las siguientes unidades de longitud y de masa como se te pide:
