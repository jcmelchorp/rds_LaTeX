...
\item Resolver problemas que involucren la suma, resta y multiplicación de exponentes, y expresar números en notación científica.
...
\questionboxed[4]{Resuelve los siguientes problemas:
	...
	\questionboxed[2]{Calcula el \textbf{volumen}, el \textbf{área lateral} y el \textbf{área total} de las siguientes figuras:
		...
		\begin{parts}
			\part Pirámide cuyos lados \item l\item  de la base miden 16 cm y la altura \item h\item  mide 27 cm.
			...
			\part Pirámide de 19 cm de altura cuya base es un pentágono cuyos lados \item l\item  miden 8 cm y su apotema mide 5 cm.
...
\ejemplosboxed[]{Contesta las siguientes preguntas:
    ...
    \subsubsection{Lenguaje algebraico}
    \ejemplosboxed[6]{Escribe la expresión algebraica correcta para los siguientes enunciados:
                \begin{multicols}{2}
                    \begin{parts}
    ...
    \ejemplosboxed[3]{Numera correctamente los pasos para resolver un sistema de dos ecuaciones con dos inc\'ognitas por los m'etodos a continuaci\'on:
