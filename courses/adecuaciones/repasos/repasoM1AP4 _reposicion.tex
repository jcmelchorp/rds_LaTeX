...
\materia{Matemáticas 1 \normalfont \color{darkgray} \\[-0.2em] \small con \textbf{\color{brown}adecuación curricular} a Matemáticas 4$^\circ$ de Primaria}
\unidad{1, 2 y 3}
	...
	\questionboxed[2]{Escribe sore la línea los siguientes números:
		...
		\begin{multicols}{2}
			\begin{parts}
				...
				\part \fillin[ 1024][1.5cm] Mil veinticuatros.
