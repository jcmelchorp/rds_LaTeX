...
\begin{questions}\large
   ...
   \question[8]{Realiza las siguientes sumas y restas:
   ...
   \end{multicols}
	...
	\question[8]{Resuelve los siguientes problemas sobre sumas, restas y multiplicaciones:
...
\question[8]{Calcula el {\color{red}cociente} y {\color{blue} residuo} de las siguientes divisiones de números enteros:
   ...
   \end{multicols}
	...
	\question[8]{Escribe en el recuadro el número decimal que representa el punto en la recta numérica de cada imagen:

		\begin{multicols}{2}
			\begin{parts}
				\part \includegraphics[width=200px]{../images/recta_num_6.01.png}  \hfill \fillin[\fbox{6.01}][0in] \\
				...
				\part \includegraphics[width=200px]{../images/recta_num_1.85.png}  \hfill \fillin[\fbox{1.85}][0in] \\
				% \part \includegraphics[width=180px]{../images/recta_num_9.7.png}   \hfill \fillin[\fbox{9.7 }][0in] \\
				\part \includegraphics[width=200px]{../images/recta_num_1.12.png}  \hfill \fillin[\fbox{1.12}][0in] \\
				\part \includegraphics[width=200px]{../images/recta_num_5.69.png}  \hfill \fillin[\fbox{5.69}][0in] \\
	...
	\question[8]{Escribe los siguientes números
	...
	\question[8]{\textbf{Redondea} los siguientes números decimales como se pide:
   ...
   \question[12]{Realiza las siguientes sumas, restas, multiplicaciones y divisiones con números decimales:
   ...
   \begin{multicols}{3}
      \begin{parts}
         ...
         \part \ifprintanswers{\opdiv[shiftdecimalsep=divisor,strikedecimalsepsymbol=\hspace{-2.5pt}\tiny\color{red!50!black}$\times$]{4.025}{0.3}} 
         \else{           $0.3 \overline{) \ 4.025\ }$} \\[0.5em]\fi


         \part \ifprintanswers{\normalsize\opmul[hfactor=decimal,resultstyle=\color{red},displayintermediary=all]{2.5}{0.3} }
         \else{\opmul[hfactor=decimal,resultstyle=\color{white},displayintermediary=None]{2.5}{0.3}}\\[2em]\fi
      
         \part \ifprintanswers{\opdiv[shiftdecimalsep=divisor,strikedecimalsepsymbol=\hspace{-2.5pt}\tiny\color{red!50!black}$\times$]{17.6}{0.2}} 
         \else{           $0.2 \overline{) \ 17.6\ }$} \\[1em]
         \fi
      \end{parts}
   \end{multicols}
}
	...
	\question[4]{Escribe los siguientes porcentajes como números decimales:
	...
	\question[12]{Realiza las siguientes operaciones:
	...
	\question[8]{Convierte las siguientes fracciones a decimal:
		...
		\begin{multicols}{4}
			\begin{parts}
				...
				\part $\dfrac{1}{2} =$   \fillin[\fbox{$0.875$}][0cm]\\
	...
	% \question[8]{Convierte los siguientes números decimales a una fracción \textbf{simplificada} a su mínima expresión:
