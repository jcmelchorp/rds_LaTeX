...
\materia{Matemáticas 1 \normalfont \color{darkgray} \small con adecuación curricular a \\Matemáticas 1$^\circ$ de Primaria.}
\unidad{1, 2 y 3}
...
\begin{questions}\large
	...
	\question[15]{Escribe sobre la línea la cantidad de puntos {\color{red} rojos} que aparecen en cada figura:
	...
	\question[15]{Escribe sobre la línea los siguientes números:
	...
	\question[3]{Escribe la notación desarrollada de cada uno de los siguientes números:
	...
	\subsection*{Sumas}
	\question[12]{Realiza las siguientes sumas:
...
\question[12]{Realiza las siguientes restas:
...
\question[2]{Contando de \textbf{1 en 1}, contesta las siguientes preguntas:
	...
	\question[2]{Contando de \textbf{2 en 2}, contesta las siguientes preguntas:
	...
	\question[2]{Contando de \textbf{3 en 3}, contesta las siguientes preguntas:
	...
	\question[10]{Reponde las siguientes tablas de multiplicar:
