...
\begin{questions}\large
	...
	\question[2]{Escribe sobre la línea la fracción que representa cada imagen:
		...
		\begin{multicols}{4}
			\begin{parts}
				\part \includegraphics[width=44px]{../images/imagen_frac11.png} \fillin[\fbox{$\dfrac{1}{20}$}][0in] \\[1em]
				\part \includegraphics[width=44px]{../images/imagen_frac01.png} \fillin[\fbox{$\dfrac{10}{20}$}][0in] \\[1em]
				% \part \includegraphics[width=44px]{../images/imagen_frac02.png} \fillin[\fbox{$\dfrac{5}{6}$}][0in] \\[1em]
				\part \includegraphics[width=44px]{../images/imagen_frac03.png} \fillin[\fbox{$\dfrac{11}{16}$}][0in] \\[1em]
				\part \includegraphics[width=44px]{../images/imagen_frac04.png} \fillin[\fbox{$\dfrac{14}{16}$}][0in] \\[1em]
				\part \includegraphics[width=44px]{../images/imagen_frac05.png} \fillin[\fbox{$\dfrac{17}{20}$}][0in] \\[1em]
				\part \includegraphics[width=44px]{../images/imagen_frac06.png} \fillin[\fbox{$\dfrac{9}{16}$}][0in] \\[1em]
				\part \includegraphics[width=44px]{../images/imagen_frac07.png} \fillin[\fbox{$\dfrac{15}{20}$}][0in] \\[1em]
				% \part \includegraphics[width=44px]{../images/imagen_frac08.png} \fillin[\fbox{$\dfrac{7}{8}$}][0in] \\[1em]
				\part \includegraphics[width=44px]{../images/imagen_frac09.png} \fillin[\fbox{$\dfrac{13}{20}$}][0in] \\[1em]
			\end{parts}
		\end{multicols}
	}
	...
	\question[2]{Escribe sobre la línea el nombre que recibe cada figura geométrica de acuerdo con su número de lados:
		...
		\begin{multicols}{3}
			\begin{parts}
				\part \includegraphics[width=55px]{../images/pentagono_azul.png}  \fillin[pentágono][0.75in]
				\part \includegraphics[width=55px]{../images/nonagono_azul.png}   \fillin[nonágono][0.75in]
				\part \includegraphics[width=55px]{../images/decagono_azul.png}   \fillin[decágono][0.75in]
				\part \includegraphics[width=55px]{../images/hexagono_azul.png}   \fillin[hexágono][0.75in]
				\part \includegraphics[width=55px]{../images/rectangulo_azul.png} \fillin[rectángulo][0.75in]
				\part \includegraphics[width=55px]{../images/cuadrado_azul.png}   \fillin[cuadrado][0.75in]
			\end{parts}
		\end{multicols}
	}
