...
\materia{Matemáticas 1 \normalfont \color{darkgray} \small con adecuación curricular a \\Matemáticas 2$^\circ$ de Primaria.}
\unidad{1, 2 y 3}
...
\begin{questions}\large
	...
	% \question[5]{Escribe sobre la línea la cantidad de puntos {\color{red} rojos} que aparecen en cada figura:
	...
	\question[10]{Escribe sobre la línea la cantidad de puntos {\color{red} rojos} que aparecen en cada figura:
	...
	\question[5]{Escribe sobre la línea los siguientes números:
	...
	% \question[5]{Escribe en el recuadro el número que representa el punto en la recta numérica de cada imagen:
	...
	\question[10]{Escribe en el recuadro el número que representa el punto en la recta numérica de cada imagen:

		\begin{multicols}{2}
			\begin{parts}
				\part \includegraphics[width=150px]{../images/recta_num_26.png}   \hfill \fillin[26][1cm]
				\part \includegraphics[width=150px]{../images/recta_num_21.png}   \hfill \fillin[21][1cm]
				\part \includegraphics[width=150px]{../images/recta_num_31.png}   \hfill \fillin[31][1cm]
				\part \includegraphics[width=150px]{../images/recta_num_24.png}   \hfill \fillin[24][1cm]
				\part \includegraphics[width=150px]{../images/recta_num_34.png}   \hfill \fillin[34][1cm]
				\part \includegraphics[width=150px]{../images/recta_num_50.png}   \hfill \fillin[50][1cm]
				\part \includegraphics[width=150px]{../images/recta_num_41.png}   \hfill \fillin[41][1cm]
				\part \includegraphics[width=150px]{../images/recta_num_48.png}   \hfill \fillin[48][1cm]
				\part \includegraphics[width=150px]{../images/recta_num_36.png}   \hfill \fillin[36][1cm]
				\part \includegraphics[width=150px]{../images/recta_num_39.png}   \hfill \fillin[39][1cm]
			\end{parts}
		\end{multicols}
	}
	...
	\question[5]{Señala la opción que responda correctamente a cada una de las siguientes preguntas:
	...
	\question[8]{Realiza las siguientes sumas:
	...
	\question[6]{Contando de \textbf{4 en 4}, contesta las siguientes preguntas:
	...
	\question[6]{Contando de \textbf{5 en 5}, contesta las siguientes preguntas:
	...
	\question[6]{Contando de \textbf{6 en 6}, contesta las siguientes preguntas:
	...
	\question[12]{Reponde las siguientes tablas de multiplicar:
	...
	\question[6]{Escribe sobre la línea el nombre que recibe cada figura geométrica de acuerdo con su número de lados:
	...
	\question[6]{Clasifica las siguientes fracciones en propias, impropias o mixtas:

		\begin{multicols}{4}
			\begin{parts}
				\part $\dfrac{6}{5}$   \fillin[Impropia][2cm]   \\[0.5em]
				\part $\dfrac{5}{6}$   \fillin[Propia][2cm]     \\[0.5em]
				\part $\dfrac{13}{12}$   \fillin[Impropia][2cm] \\[0.5em]
				\part $5\dfrac{5}{11}$ \fillin[Mixta][2cm]      \\[0.5em]
				\part $\dfrac{16}{9}$   \fillin[Impropia][2cm]  \\[0.5em]
				\part $1\dfrac{2}{15}$  \fillin[Mixta][2cm]     \\[0.5em]
				\part $\dfrac{42}{43}$   \fillin[Propia][2cm]   \\[0.5em]
				\part $\dfrac{7}{3}$   \fillin[Impropia][2cm]   \\[0.5em]
				\part $3\dfrac{2}{9}$  \fillin[Mixta][2cm]      \\[0.5em]
				\part $\dfrac{3}{2}$   \fillin[Impropia][2cm]   \\[0.5em]
				\part $1\dfrac{2}{3}$  \fillin[Mixta][2cm]      \\[0.5em]
				\part $\dfrac{7}{8}$   \fillin[Propia][2cm]     \\[0.5em]
			\end{parts}
		\end{multicols}
	}

	\question[6]{Escribe sobre la línea la fracción que representa cada imagen:
